...
const EventCard = (props: any) => {
  ...
  return (
    <div
      ...
      odd:border-blue-200 even:border-blue-200 odd:bg-blue-100 even:bg-blue-100 even:selection:bg-slate-200  even:dark:border-slate-700 odd:dark:border-slate-800 odd:dark:bg-sky-600/[0.1] even:dark:bg-slate-800/[0.5] "
    >
      <TooltipElement
        element={
